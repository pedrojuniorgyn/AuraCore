/**
 * Drizzle Fiscal Accounting Repository
 * 
 * Implementação do repositório para contabilização de documentos fiscais.
 * 
 * NOTA: Este repositório implementa IFiscalAccountingRepository, NÃO IJournalEntryRepository.
 * - IFiscalAccountingRepository: Contabilização de NFe, CTe → lançamentos contábeis
...
/**
 * Factory para criar repositório de contabilização fiscal
 */
export function createFiscalAccountingRepository(): DrizzleFiscalAccountingRepository {
  return new DrizzleFiscalAccountingRepository();
}

/**
 * @deprecated Use createFiscalAccountingRepository() instead
 */
export function createJournalEntryRepository(): DrizzleFiscalAccountingRepository {
  return new DrizzleFiscalAccountingRepository();
}
