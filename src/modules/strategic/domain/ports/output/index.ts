/**
 * Output Ports do Módulo Strategic
 * 
 * @module strategic/domain/ports/output
 */
export type { IStrategyRepository, StrategyFilter } from './IStrategyRepository';
export type { IStrategicGoalRepository, GoalFilter } from './IStrategicGoalRepository';
export type { IActionPlanRepository, ActionPlanFilter } from './IActionPlanRepository';
