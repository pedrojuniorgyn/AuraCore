  ...
  return (
    <div className="p-6 space-y-4">
      <div className="flex items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold">Auditoria — Conciliação (Achados)</h1>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Input value={runId} onChange={(e) => setRunId(e.target.value)} placeholder="Filtrar por runId (UUID)" className="w-[280px]" />
