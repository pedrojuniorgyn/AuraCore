...
import { getEndpointStats } from "@/lib/observability/request-buffer";
...
/**
 * GET /api/admin/diagnostics/endpoints
 * 
 * Retorna estatísticas agregadas por endpoint (p50/p95/p99).
 *
 * Query params:
 * - sinceMinutes (default 60) - Janela de tempo em minutos
 * - limit (default 50) - Número máximo de endpoints
 * 
 * @example Response
 * {
 *   "success": true,
 ...
 *   "endpoints": [
 *     {
 *       "endpoint": "POST /api/financial/payables/ssrm",
 *       "method": "POST",
 *       "path": "/api/financial/payables/ssrm",
 *       "count": 150,
 *       "avgDurationMs": 45,
 *       "p50DurationMs": 38,
 *       "p95DurationMs": 120,
 ...
 *       "errorCount": 2,
 *       "errorRate": 1.33,
 *       "lastRequestAt": "2026-01-19T10:30:00.000Z"
 *     }
 *   ]
 * }
 * 
